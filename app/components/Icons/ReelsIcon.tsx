...
export const ReelsFilled = () => {
    return (
        <Svg fill="#000000" xmlns="http://www.w3.org/2000/Svg" viewBox="0 0 50 50" width="24px" height="24px"><Path d="M13.34,4.13L20.26,16H4v-1C4,9.48,8.05,4.92,13.34,4.13z" /><Polygon points="33.26,16 22.57,16 15.57,4 26.26,4" /><Path d="M46,15v1H35.57l-7-12H35C41.08,4,46,8.92,46,15z" /><Path d="M4,18v17c0,6.08,4.92,11,11,11h20c6.08,0,11-4.92,11-11V18H4z M31,32.19l-7.99,4.54C21.68,37.49,20,36.55,20,35.04v-9.08	c0-1.51,1.68-2.45,3.01-1.69L31,28.81C32.33,29.56,32.33,31.44,31,32.19z" /></Svg>
    );
};
